...
<style>
    ...
    .card{
        ...
        box-shadows: 0 4px 30px rgba(0, 0, 0, 0.4) !important;
    ...
    .card-header-dark, .card-header span, h5, h6{
    ...
    .btn-primary:hover{
        ...
        bo-shadow: 0 6px 20px rgba(0, 229, 255, 0.5);
    }
    ...
    .bg-success { background-color: rgba(16, 185, 129, 0.12) !important; color: #10b981 !important; border: 1px solid rgba(16, 185, 129, 0.3); }
    .bg-primary { background-color: rgba(59, 130, 246, 0.12) !important; color: #3b82f6 !important; border: 1px solid rgba(59, 130, 246, 0.3); }
    .bg-warning { background-color: rgba(245, 158, 11, 0.12) !important; color: #f59e0b !important; border: 1px solid rgba(245, 158, 11, 0.3); }
    .bg-light { background-color: rgba(255, 255, 255, 0.05) !important; color: #cbd5e1 !important; border: 1px solid rgba(255, 255, 255, 0.1); }
    .bg-secondary { background-color: rgba(156, 163, 175, 0.15) !important; color: #e5e7eb !important; border: 1px solid rgba(156, 163, 175, 0.3);}
